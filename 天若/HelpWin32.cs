...
namespace TrOCR
{
	public class HelpWin32
	{
		...
		public static bool CaptureWindow(Control control, ref Bitmap bitmap)
		{
			...
			IntPtr intPtr = new IntPtr(12);
			IntPtr hdc = graphics.GetHdc();
			HelpWin32.SendMessage(control.Handle, 791, hdc, intPtr);
		...
		public class IniFileHelper
		{
			...
			public static bool SetValue(string sectionName, string key, string value, string filePath)
			{
				...
				try
				{
					flag = (int)HelpWin32.IniFileHelper.WritePrivateProfileString(sectionName, key, value, filePath) > 0;
				}
				catch (Exception ex)
				{
					throw ex;
			...
			public static bool RemoveSection(string sectionName, string filePath)
			{
				...
				try
				{
					flag = (int)HelpWin32.IniFileHelper.WritePrivateProfileString(sectionName, null, "", filePath) > 0;
				}
				catch (Exception ex)
				{
					throw ex;
			...
			public static bool Removekey(string sectionName, string key, string filePath)
			{
				...
				try
				{
					flag = (int)HelpWin32.IniFileHelper.WritePrivateProfileString(sectionName, key, null, filePath) > 0;
				}
				catch (Exception ex)
				{
					throw ex;
