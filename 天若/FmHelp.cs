...
public partial class FmHelp : Form
{
    ...
    private void FmHelpLoad(object sender, EventArgs e)
    {
        ...
        panel_识别说明.Location = DpiSize( );
        using StreamWriter streamWriter = new("52.txt", true);
    ...
    private void ListBoxDrawItem(object sender, DrawItemEventArgs e)
    {
        ...
        {
            Rectangle rectangle = new(bounds.Left, bounds.Top + 1, bounds.Width, bounds.Height - 4);
            graphics.FillRectangle(Brushes.LightSkyBlue, rectangle);
        }
        else
        {
    ...
    private void ListBoxSelectedChanged(object sender, EventArgs e)
    {
        if (listBox1.SelectedItem.ToString( ).Trim( ) == "快捷键")
        {
            panel_快捷键.Location = DpiSize( );
