...
public partial class FmMain : Form
{
    public FmMain( )
    {
        ...
        components = null;
        InitializeComponent( );
        nextClipboardViewer = (IntPtr) HelpWin32.SetClipboardViewer((int) base.Handle);
        InitMinimize( );
        readIniFile( );
    ...
    protected override void WndProc(ref Message m)
    {
        ...
        else
        {
            ...
            if (m.Msg == 786 && m.WParam.ToInt32( ) == 580)
            {
                ...
                base.Hide( );
                form_width = transtalate_fla == "开启" ? base.Width / 2 : base.Width;
                form_height = base.Height;
                ...
                base.Size = new Size((int) font_base.Width * 23, (int) font_base.Height * 24);
            ...
            {
                base.WindowState = FormWindowState.Normal;
                base.Size = new Size((int) font_base.Width * 23 * 2, (int) font_base.Height * 24);
    ...
    public void InitMinimize( )
    {
        ...
        try
        {
            ...
            minico.ContextMenu = new ContextMenu(array);
        }
        catch (Exception ex)
        {
    ...
    public void Split_Click(object sender, EventArgs e) => RichBoxBody.Text = split_txt;
    ...
    private static Bitmap GetPlus(Bitmap bm, double times)
    {
        int num = (int) (bm.Width / times);
        int num2 = (int) (bm.Height / times);
        Bitmap bitmap = new(num, num2);
        if (times is >= 1.0 and <= 1.1)
        {
            bitmap = bm;
        }
        else
    ...
    private void OCR_sougou_Click(object sender, EventArgs e) => OCR_foreach("搜狗");

    private void OCR_tencent_Click(object sender, EventArgs e) => OCR_foreach("腾讯");
    ...
    public void OCR_youdao_Click(object sender, EventArgs e) => OCR_foreach("有道");
    ...
    public void change_Chinese_Click(object sender, EventArgs e)
    {
        ...
        if (typeset_txt != "")
        {
            RichBoxBody.Text = FmMain.punctuation_en_ch_x(RichBoxBody.Text);
    ...
    public void change_English_Click(object sender, EventArgs e)
    {
        ...
        if (typeset_txt != "")
        {
            RichBoxBody.Text = FmMain.punctuation_ch_en(RichBoxBody.Text);
        }
    }
    ...
    public void saveIniFile( ) => IniHelp.SetValue("配置", "接口", interface_flag);
    ...
    public void tray_limit_Click(object sender, EventArgs e) => new Thread(new ThreadStart(about)).Start( );
    ...
    public static bool own_punctuation(string text) => ",;，、__《》()-（）.。".IndexOf(text) != -1;
    ...
    public static bool contain_ch(string str) => Regex.IsMatch(str, "[\\u4e00-\\u9fa5]");
    ...
    public void transtalate_Click( )
    {
        ...
        if (num_ok == 0)
        {
            RichBoxBody.Size = new Size(base.ClientRectangle.Width, base.ClientRectangle.Height);
            base.Size = new Size(RichBoxBody.Width * 2, RichBoxBody.Height);
    ...
    private void Form_Resize(object sender, EventArgs e)
    {
        ...
        {
            RichBoxBody.Size = new Size(base.ClientRectangle.Width / 2, base.ClientRectangle.Height);
            RichBoxBody_T.Size = new Size(RichBoxBody.Width, base.ClientRectangle.Height);
            RichBoxBody_T.Location = (Point) new Size(RichBoxBody.Width, 0);
        }
    }
    ...
    public void trans_Calculate( )
    {
        if (pinyin_flag)
        {
            googleTranslate_txt = FmMain.PinYin.ToPinYin(typeset_txt);
        }
        else if (typeset_txt == "")
        {
            googleTranslate_txt = "";
        ...
        base.Invoke(new FmMain.translate(translate_child));
        pinyin_flag = false;
    }
    ...
    public static bool contain(string text, string subStr) => text.Contains(subStr);
    ...
    {
        string text = FmMain.contain_ch(str) ? "[\\；\\，\\。\\！\\？]" : "[\\;\\,\\.\\!\\?]";
        return Regex.IsMatch(str, text);
    }

    public static string quotation(string str) => Regex.Replace(str.Replace("“", "\"").Replace("”", "\""), "(?<=\")([^\\\"\\“\\”]+)(?=\")", "$1_测_$2");

    private static string punctuation_quotation(string pStr)
    {
    ...
    public void TTS( ) => new Thread(new ThreadStart(TTS_thread)).Start( );
    ...
    public void TTS_thread( )
    {
        try
        {
            ...
            responseStream.Close( );
            string text2 = !FmMain.contain_ch(htmltxt) ? "zh" : "zh";
            ...
            {
                base.Invoke(new FmMain.translate(Speak_child));
                speak_copyb = "";
            }
            else
            {
                base.Invoke(new FmMain.translate(TTS_child));
            }
            voice_count++;
        }
        catch (Exception ex)
    ...
    public static string GetGoogletHtml(string url, CookieContainer cookie, string refer)
    {
        string text = "";
    ...
    public static string Translate_Google(string text)
    {
        string text2 = "";
        try
        {
    ...
    public void tray_update_Click(object sender, EventArgs e) => Program.CheckUpdate( );

    public static bool contain_jap(string str) => Regex.IsMatch(str, "[\\u3040-\\u309F]") || Regex.IsMatch(str, "[\\u30A0-\\u30FF]");

    public static bool contain_kor(string str) => Regex.IsMatch(str, "[\\uac00-\\ud7ff]");
    ...
    public static string repalceStr(string hexData) => Regex.Replace(hexData, "[\\p{P}+~$`^=|__～\uff40＄\uff3e＋＝｜＜＞￥×┊ ]", "").ToUpper(System.Globalization.CultureInfo.CurrentCulture);
    ...
    public void change_zh_tra_Click(object sender, EventArgs e)
    {
        ...
        {
            RichBoxBody.Text = FmMain.ToTraditional(RichBoxBody.Text);
        }
    }
    ...
    public void change_tra_zh_Click(object sender, EventArgs e)
    {
        if (RichBoxBody.Text != null)
        {
            RichBoxBody.Text = FmMain.ToSimplified(RichBoxBody.Text);
        }
    }
    ...
    public static string[] hotkey(string text, string text2, string value)
    {
    ...
    public string Google_Hotkey(string text)
    {
        ...
        try
        {
            string text3;
            string text4;
            if (FmMain.contain_ch(trans_hotkey.Trim( )))
            {
                text3 = "zh-CN";
                text4 = "en";
            }
    ...
    private string GetTextFromClipboard( )
    {
        ...
        {
            Thread thread = new(new ThreadStart(FmMain.__c.__9.GetTextFromClipboard));
    ...
    public static CookieContainer Post_Html_Getcookie(string url, string post_str)
    {
    ...
    public static string Post_Html_Reccookie(string url, string post_str, CookieContainer CookieContainer)
    {
        byte[] bytes = Encoding.UTF8.GetBytes(post_str);
        string text = "";
        HttpWebRequest httpWebRequest = WebRequest.Create(url) as HttpWebRequest;
    ...
    public void Main_OCR_Thread( )
    {
        if (ScanQRCode( ) != "")
        {
            ...
            fmloading.fml_close = "窗体已关闭";
            base.Invoke(new FmMain.ocr_thread(Main_OCR_Thread_last));
            return;
        }
        ...
        if (interface_flag == "百度表格")
        {
            OCR_baidu_table( );
            fmloading.fml_close = "窗体已关闭";
            base.Invoke(new FmMain.ocr_thread(Main_OCR_Thread_table));
            return;
        }
    ...
    public void Main_OCR_Thread_last( )
    {
        ...
        base.TopMost = StaticValue.v_topmost;
        Text = "耗时：" + text2;
        minico.Visible = true;
        ...
        base.Show( );
        base.WindowState = FormWindowState.Normal;
        base.Size = new Size(form_width, form_height);
        HelpWin32.SetForegroundWindow(base.Handle);
        ...
        if (bool.Parse(IniHelp.GetValue("工具栏", "翻译")))
        {
            ...
            {
                auto_fla = "";
                base.Invoke(new FmMain.translate(transtalate_Click));
            }
            catch
            {
            }
    ...
    private void OCR_baidu_Ch_and_En_Click(object sender, EventArgs e) => OCR_foreach("中英");

    private void OCR_baidu_Jap_Click(object sender, EventArgs e) => OCR_foreach("日语");

    private void OCR_baidu_Kor_Click(object sender, EventArgs e) => OCR_foreach("韩语");

    public static string Get_GoogletHtml(string url)
    {
        string text = "";
        HttpWebRequest httpWebRequest = WebRequest.Create(url) as HttpWebRequest;
        httpWebRequest.Method = "GET";
    ...
    public void OCR_baidu( )
    {
        ...
        try
        {
            baidu_vip = FmMain.Get_html(string.Format("{0}?{1}", "https://aip.baidubce.com/oauth/2.0/token", "grant_type=client_credentials&client_id=" + StaticValue.baiduAPI_ID + "&client_secret=" + StaticValue.baiduAPI_key));
            if (baidu_vip == "")
            {
    ...
    public static string check_str(string text)
    {
        if (FmMain.contain_ch(text.Trim( )))
        {
    ...
    public static string OCR_sougou_SogouPost(string url, CookieContainer cookie, byte[] content)
    {
        string text = "";
        HttpWebRequest httpWebRequest = WebRequest.Create(url) as HttpWebRequest;
        httpWebRequest.Method = "POST";
    ...
    public static string OCR_sougou_SogouGet(string url, CookieContainer cookie, string refer)
    {
        string text = "";
        HttpWebRequest httpWebRequest = WebRequest.Create(url) as HttpWebRequest;
        httpWebRequest.Method = "GET";
    ...
    public static byte[] OCR_sougou_Content_Length(Image img)
    {
    ...
    public static bool contain_punctuation(string str) => Regex.IsMatch(str, "\\p{P}");
    ...
    public static bool Is_punctuation(string text) => ",;:，（）、；".IndexOf(text) != -1;

    public static bool has_punctuation(string text) => ",;，；、<>《》()-（）".IndexOf(text) != -1;
    ...
    public void checked_txt(JArray jarray, int lastlength, string words)
    {
        ...
        for (int j = 0; j < jarray.Count - 1; j++)
        {
            ...
            {
                if (split_paragraph(array[array.Length - lastlength].ToString( )) && FmMain.contain_en(array2[0].ToString( )))
                {
                    text2 = text2 + jobject[words].ToString( ).Trim( ) + "\r\n";
                }
                else if (split_paragraph(array[array.Length - lastlength].ToString( )) && FmMain.IsNum(array2[0].ToString( )))
                {
                    text2 = text2 + jobject[words].ToString( ).Trim( ) + "\r\n";
                }
            ...
            else if (FmMain.contain_ch(array[array.Length - lastlength].ToString( )) && Is_punctuation(array2[0].ToString( )))
            {
                text2 += jobject[words].ToString( ).Trim( );
            }
            else if (Is_punctuation(array[array.Length - lastlength].ToString( )) && FmMain.contain_ch(array2[0].ToString( )))
            {
                text2 += jobject[words].ToString( ).Trim( );
            }
            else if (Is_punctuation(array[array.Length - lastlength].ToString( )) && FmMain.contain_en(array2[0].ToString( )))
            {
                text2 = text2 + jobject[words].ToString( ).Trim( ) + " ";
            }
        ...
        split_txt = text + JObject.Parse(jarray[jarray.Count - 1].ToString( ))[words];
    ...
    private void OCR_foreach(string name)
    {
        ...
        HelpWin32.IniFileHelper.SetValue("配置", "接口", interface_flag, text);
    }
    ...
    private void OCR_write_Click(object sender, EventArgs e) => OCR_foreach("手写");

    private void OCR_lefttoright_Click(object sender, EventArgs e) => OCR_foreach("从左向右");

    private void OCR_righttoleft_Click(object sender, EventArgs e) => OCR_foreach("从右向左");
    ...
    public static bool split_paragraph(string text) => "。？！?!：".IndexOf(text) != -1;
    ...
    public static void OCR_baidu_image(Image imagearr, string str_image)
    {
        try
        {
            string text = "CHN_ENG";
    ...
    private static Image<Gray, byte> randon(Image<Gray, byte> imageInput)
    {
        ...
        for (int i = -20; i < 20; i++)
        {
            Image<Gray, byte> image2 = imageInput.Rotate(i, new Gray(1.0));
            for (int j = 0; j < height; j++)
            {
                int num2 = 0;
                for (int k = 0; k < width; k++)
                {
                    num2 += image2.Data[j, k, 0];
                }
                array[j] = num2;
            }
            int num3 = 0;
    ...
    public static void SetGlobalProxy( ) => WebRequest.DefaultWebProxy = null;
    ...
    public static string Post_Html_pinyin(string url, string post_str)
    {
        byte[] bytes = Encoding.UTF8.GetBytes(post_str);
        string text = "";
        HttpWebRequest httpWebRequest = WebRequest.Create(url) as HttpWebRequest;
    ...
    public void 翻译文本( )
    {
        if (IniHelp.GetValue("配置", "快速翻译") == "True")
        {
            ...
            try
            {
                ...
                if (IniHelp.GetValue("配置", "翻译接口") == "百度")
                {
                    text = Translate_baidu(trans_hotkey);
                }
                if (IniHelp.GetValue("配置", "翻译接口") == "腾讯")
                {
    ...
    public static bool Exist(bool[][] Colors, int x, int y) => x >= 0 && y >= 0 && x < Colors.Length && y < Colors[0].Length && Colors[x][y];
    ...
    public static Image BoundingBox_fences(Image<Gray, byte> src, Image<Bgr, byte> draw)
    {
        Image image2;
        using (VectorOfVectorOfPoint vectorOfVectorOfPoint = new( ))
        {
    ...
    public static int split_char_x(string split_char) => Convert.ToInt32(split_char.Split(new char[] { ',' })[0]);
    ...
    public static int en_count(string text) => Regex.Matches(text, "\\s+").Count + 1;

    public static int ch_count(string str)
    {
        int num = 0;
    ...
    public static int split_char_youdao(string split_char, int i) => Convert.ToInt32(split_char.Split(new char[] { ',' })[i - 1]);

    public void Trans_google_Click(object sender, EventArgs e) => Trans_foreach("谷歌");

    public void Trans_baidu_Click(object sender, EventArgs e) => Trans_foreach("百度");
    ...
    private static string Translate_baidu(string Text)
    {
        string text = "";
        try
        {
    ...
    public void Trans_tencent_Click(object sender, EventArgs e) => Trans_foreach("腾讯");

    public static string Content_Length(string text, string fromlang, string tolang) => string.Concat(new string[]
        {
            "&source=",
            fromlang,
            "&target=",
    ...
    public static string Post_GoogletHtml(string post_str)
    {
        string text = "";
    ...
    public void OCR_table_Click(object sender, EventArgs e) => OCR_foreach("表格");
    ...
    public string Translate_Googlekey(string text)
    {
        ...
        try
        {
            ...
            if (StaticValue.zh_jp)
            {
                if (FmMain.contain_jap(FmMain.repalceStr(FmMain.Del_ch(typeset_txt.Trim( )))))
                {
                    text3 = "ja";
                    text4 = "zh-CN";
                }
            ...
            if (StaticValue.zh_ko)
            {
                if (FmMain.contain_kor(typeset_txt.Trim( )))
                {
                    text3 = "ko";
                    text4 = "zh-CN";
                }
    ...
    public void OCR_baidutable_Click(object sender, EventArgs e) => OCR_foreach("百度表格");

    public void OCR_ailitable_Click(object sender, EventArgs e) => OCR_foreach("阿里表格");
    ...
    public static byte[] ImageToByteArray(Image img) => (byte[]) new ImageConverter( ).ConvertTo(img, typeof(byte[]));
    ...
    public void OCR_ali_table( )
    {
        ...
        try
        {
            ...
            Stream stream = FmMain.BytesToStream(FmMain.ImageToByteArray(BWPic((Bitmap) image_screen)));
    ...
    public static Bitmap BWPic(Bitmap mybm)
    {
    ...
    public static string Post_Html_final(string url, string post_str, string CookieContainer)
    {
        byte[] bytes = Encoding.UTF8.GetBytes(post_str);
        string text = "";
        HttpWebRequest httpWebRequest = WebRequest.Create(url) as HttpWebRequest;
    ...
    private static object ExecuteScript(string sExpression, string sCode)
    {
    ...
    private void OCR_Mathfuntion_Click(object sender, EventArgs e) => OCR_foreach("公式");
    ...
    public System.Timers.Timer esc_timer;

    public Thread esc_thread;

    public string esc;

    private readonly string languagle_flag;
    ...
    private readonly string flags_ocrorder;
    ...
    public class AutoClosedMsgBox
    {
        ...
        public static int Show(string text, string caption, int milliseconds, FmMain.MsgBoxStyle style) => FmMain.AutoClosedMsgBox.MessageBoxTimeout(IntPtr.Zero, text, caption, (int) style, 0, milliseconds);

        public static int Show(string text, string caption, int milliseconds, int style) => FmMain.AutoClosedMsgBox.MessageBoxTimeout(IntPtr.Zero, text, caption, style, 0, milliseconds);
    ...
    private class HtmlToText
    {
        ...
        {
            _text = new FmMain.HtmlToText.TextBuilder( );
            _html = html;
            _pos = 0;
            while (!EndOfText)
            {
                if (Peek( ) == '<')
                {
                    string text = ParseTag(out bool flag);
                    if (text == "body")
                    {
                        _text.Clear( );
                    }
                    ...
                    if (FmMain.HtmlToText._tags.TryGetValue(text, out string text2))
                    {
                        _text.Write(text2);
                    }
    ...
    private sealed class __c
    {
        ...
        public static readonly FmMain.__c __9 = new( );

        public static ThreadStart __9__89_0;
    }
}
